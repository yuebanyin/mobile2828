...
const PcFiftyRecords = (props: PcRecordsProps) => {
  ...
  const ballRes = [
    ...
    {
      id: 5,
      value: GameMgr.GetResultDesc(KindId, Number(ResultType[0])),
      cls: `${
    ...
    {
      id: 6,
      value: GameMgr.GetResultDesc(KindId, Number(ResultType[1])),
      cls: `${
    ...
    {
      id: 7,
      value: GameMgr.GetResultDesc(KindId, Number(ResultType[3])),
      cls: `${
    ...
    { id: 8, value: GameMgr.GetResultDesc(KindId, Number(ResultType[2])) },
    { id: 9, value: GameMgr.GetResultDesc(KindId, Number(ResultType[4])) },
  ];
    ...
    <div className='m-b-2' onClick={handleShow}>
      <div className='p-30 bg-body'>
        <div className='d-f jc-sb'>
          ...
          <div className='w-376 h-50 ta-c bg-main p-2-30'>
            ...
            >
              {`${formatMsg(
                GameMgr.GetResultDesc(KindId, Number(ResultType[0]))
              )}`}
            </span>
            <span>,</span>
            <span
            ...
            >
              {`${formatMsg(
                GameMgr.GetResultDesc(KindId, Number(ResultType[1]))
              )}`}
            </span>
          </div>
        </div>
        <BothColorLine classBox='jc-c m-t-30' GameResult={GameResult} />
