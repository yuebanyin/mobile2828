...
export namespace CMD_2901 {
  ...
  export enum emLimitType {
    LT_T_DING0 = 0, //特码-定位(00,27)
    LT_T_DING1, //特码-定位(01,26)
    LT_T_DING2, //特码-定位(02,25)
    LT_T_DING3, //特码-定位(03,24)
    LT_T_DING4, //特码-定位(04,23)
    LT_T_DING5, //特码-定位(05,22)
    LT_T_DING6, //特码-定位(06,21)
    LT_T_DING7, //特码-定位(07,20)
    LT_T_DING8, //特码-定位(08,19)
    LT_T_DING9, //特码-定位(09,18)
    LT_T_DING10, //特码-定位(10,17)
    LT_T_DING11, //特码-定位(11,16)
    LT_T_DING12, //特码-定位(12,15)
    LT_T_DING13, //特码-定位(13,14)
    LT_T_DX, //特码-大小
    LT_T_DS, //特码-单双
    LT_T_ZUHE, //特码-组合（大单、小单、大双、小双）
    LT_T_JIZHI, //特码-极值
    LT_T_BO, //特码-色波
    LT_T_PAIXING, //特码-牌型（顺子、豹子、对子）
    LT_T_LHH, //特码-龙虎和
    LT_D1_DIAN, //定位球1-单点
    LT_D1_DX, //定位球1-大小
    LT_D1_DS, //定位球1-单双
  ...
  //长龙子类型 - 特码-大小
  export enum emChangLongSubTypeTeDX {
    CLST_TDX_DA = 0, //大
    CLST_TDX_XIAO, //小
  }

  //长龙子类型 - 特码-单双
  export enum emChangLongSubTypeTeDS {
    CLST_TDS_DAN, //单
    CLST_TDS_SHUANG, //双
  }

  //长龙子类型 - 特码-波色
  export enum emChangLongSubTypeTeBO {
    CLST_TBO_HONG, //红
    CLST_TBO_LAN, //蓝
    CLST_TBO_LV, //绿
  }
  ...
  //长龙子类型 - 特码-龙虎和
  export enum emChangLongSubTypeTeLHH {
    CLST_TLHH_LONG, //龙
    CLST_TLHH_HU, //虎
    CLST_TLHH_HE, //和
  }
  ...
  export const subTypeMap = new Map<number, any>([
    [
      emChangLongMainType.CLMT_TE_DX,
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_DA,
          clSubMainType: emChangLongSubTypeTeDX.CLST_TDX_DA,
          oddID: emMultipleType.MT_T_DA_S,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_XIAO,
          clSubMainType: emChangLongSubTypeTeDX.CLST_TDX_XIAO,
          oddID: emMultipleType.MT_T_XIAO_S,
        },
      ],
    ],
    [
      emChangLongMainType.CLMT_TE_DS,
      [
        {
          title: 'DAN',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_DAN,
          clSubMainType: emChangLongSubTypeTeDS.CLST_TDS_DAN,
          oddID: emMultipleType.MT_T_DAN_S,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_SHUANG,
          clSubMainType: emChangLongSubTypeTeDS.CLST_TDS_SHUANG,
          oddID: emMultipleType.MT_T_SHUANG_S,
        },
      ],
    ],
    [
      emChangLongMainType.CLMT_TE_BO,
      [
        {
          title: 'red',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_HONG,
          clSubMainType: emChangLongSubTypeTeBO.CLST_TBO_HONG,
          oddID: emMultipleType.MT_T_HONG,
        },
        {
          title: 'blue',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_LAN,
          clSubMainType: emChangLongSubTypeTeBO.CLST_TBO_LAN,
          oddID: emMultipleType.MT_T_LAN,
        },
        {
          title: 'green',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_LV,
          clSubMainType: emChangLongSubTypeTeBO.CLST_TBO_LV,
          oddID: emMultipleType.MT_T_LV,
        },
      ],
    ],
    [
      emChangLongMainType.CLMT_TE_LHH,
      [
        {
          title: 'LONG',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_LONG,
          clSubMainType: emChangLongSubTypeTeLHH.CLST_TLHH_LONG,
          oddID: emMultipleType.MT_T_LONG,
        },
        {
          title: 'HU',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_HU,
          clSubMainType: emChangLongSubTypeTeLHH.CLST_TLHH_HU,
          oddID: emMultipleType.MT_T_HU,
        },
        {
          title: 'HE',
          mainType: emBetMainType.BTM_TE,
          subMainType: emSubBetTypeTeMa.SBTT_HE,
          clSubMainType: emChangLongSubTypeTeLHH.CLST_TLHH_HE,
          oddID: emMultipleType.MT_T_HE,
        },
      ],
    ],
  ]);
  ...
  export class tagUserBetInfo extends Struct {
    ...
    cbNumber = CreateArray(BYTE, [1]); //自选号码
  ...
  export class CMD_C_PlaceBet extends Struct {
    placeBetHead = CreateObject(common.tagCommonBetClientHead);
    tagCommonBetInfo = CreateArray(
      common.tagCommonBetInfo,
      [common.LEN_SSC_BET_COUNT],
      0,
