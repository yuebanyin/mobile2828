...
export namespace CMD_2905 {
  ...
  export const subTypeMap = new Map<number, any>([
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_H_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_H_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DAN',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_H_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_H_SHUANG,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'LONG',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_LONG,
          clSubMainType: emChangLongSubTypeLHH.CLST_LHH_LONG,
          oddID: emMultipleType.MT_H_LONG,
        },
        {
          title: 'HU',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_HU,
          clSubMainType: emChangLongSubTypeLHH.CLST_LHH_HU,
          oddID: emMultipleType.MT_H_HU,
        },
        {
          title: 'HE',
          mainType: emBetMainType.BTM_HE,
          subMainType: emSubBetTypeZongHe.SBTH_HE,
          clSubMainType: emChangLongSubTypeLHH.CLST_LHH_HE,
          oddID: emMultipleType.MT_H_HE,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_DING_1,
          subMainType: emSubBetTypeDingWei.SBTD_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_D1_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_DING_1,
          subMainType: emSubBetTypeDingWei.SBTD_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_D1_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_DING_2,
          subMainType: emSubBetTypeDingWei.SBTD_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_D2_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_DING_2,
          subMainType: emSubBetTypeDingWei.SBTD_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_D2_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_DING_3,
          subMainType: emSubBetTypeDingWei.SBTD_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_D3_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_DING_3,
          subMainType: emSubBetTypeDingWei.SBTD_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_D3_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_DING_4,
          subMainType: emSubBetTypeDingWei.SBTD_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_D4_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_DING_4,
          subMainType: emSubBetTypeDingWei.SBTD_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_D4_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DA',
          mainType: emBetMainType.BTM_DING_5,
          subMainType: emSubBetTypeDingWei.SBTD_DA,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_DA,
          oddID: emMultipleType.MT_D5_DA,
        },
        {
          title: 'XIAO',
          mainType: emBetMainType.BTM_DING_5,
          subMainType: emSubBetTypeDingWei.SBTD_XIAO,
          clSubMainType: emChangLongSubTypeDX.CLST_DX_XIAO,
          oddID: emMultipleType.MT_D5_XIAO,
        },
      ],
    ],
    [
      ...
      [
        {
          title: 'DAN',
          mainType: emBetMainType.BTM_DING_1,
          subMainType: emSubBetTypeDingWei.SBTD_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_D1_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_DING_1,
          subMainType: emSubBetTypeDingWei.SBTD_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_D1_SHUANG,
        },
      ],
    ],
    [
      ...
      [
        {
          ...
          subMainType: emSubBetTypeDingWei.SBTD_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_D2_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_DING_2,
          subMainType: emSubBetTypeDingWei.SBTD_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_D2_SHUANG,
        },
      ],
    ],
    [
      ...
      [
        {
          ...
          subMainType: emSubBetTypeDingWei.SBTD_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_D3_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_DING_3,
          subMainType: emSubBetTypeDingWei.SBTD_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_D3_SHUANG,
        },
      ],
    ],
    [
      ...
      [
        {
          ...
          subMainType: emSubBetTypeDingWei.SBTD_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_D4_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_DING_4,
          subMainType: emSubBetTypeDingWei.SBTD_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_D4_SHUANG,
        },
      ],
    ],
    [
      ...
      [
        {
          ...
          subMainType: emSubBetTypeDingWei.SBTD_DAN,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_DAN,
          oddID: emMultipleType.MT_D5_DAN,
        },
        {
          title: 'SHUANG',
          mainType: emBetMainType.BTM_DING_5,
          subMainType: emSubBetTypeDingWei.SBTD_SHUANG,
          clSubMainType: emChangLongSubTypeDS.CLST_DS_SHUANG,
          oddID: emMultipleType.MT_D5_SHUANG,
        },
      ],
    ],
  ]);
  ...
  export const mainTypeMpa = new Map([
    [emChangLongMainType.CLMT_HE_DX, 'SUM'],
    [emChangLongMainType.CLMT_HE_DS, 'SUM'],
    [emChangLongMainType.CLMT_HE_LHH, 'SUM'],
    [emChangLongMainType.CLMT_D1_DX, 'QIU_1'],
    [emChangLongMainType.CLMT_D1_DS, 'QIU_1'],
    [emChangLongMainType.CLMT_D2_DX, 'QIU_2'],
    [emChangLongMainType.CLMT_D2_DS, 'QIU_2'],
    [emChangLongMainType.CLMT_D3_DX, 'QIU_3'],
    [emChangLongMainType.CLMT_D3_DS, 'QIU_3'],
    [emChangLongMainType.CLMT_D4_DX, 'QIU_4'],
    [emChangLongMainType.CLMT_D4_DS, 'QIU_4'],
    [emChangLongMainType.CLMT_D5_DX, 'QIU_5'],
    [emChangLongMainType.CLMT_D5_DS, 'QIU_5'],
  ]);
  ...
  export const SOURCE_DATA_COUNT: number = 5; //源数据数量
  export const MAX_SOURCE_DATA_LEN: number = 1; //源数据长度
  export const MAX_BET_COUNT: number = 100; //最大下注数目
  ...
  const mapMainType = new Map<number, string>([
    ...
    [emBetMainType.BTM_DING_1, 'QIU_1'],
    [emBetMainType.BTM_DING_2, 'QIU_2'],
    [emBetMainType.BTM_DING_3, 'QIU_3'],
    [emBetMainType.BTM_DING_4, 'QIU_4'],
    [emBetMainType.BTM_DING_5, 'QIU_5'],
    [emBetMainType.BTM_SAN_QIAN, 'QIANSAN'],
    [emBetMainType.BTM_SAN_ZHONG, 'ZHOGN_SAN'],
    [emBetMainType.BTM_SAN_HOU, 'HOUSAN'],
    [emBetMainType.BTM_NIU, 'DOU_NIU'],
  ]);

  // 下注子类型 - 总和
  const mapSubZhType = new Map<number, string>([
    [emSubBetTypeZongHe.SBTH_DA, 'DA'],
    [emSubBetTypeZongHe.SBTH_XIAO, 'XIAO'],
    [emSubBetTypeZongHe.SBTH_DAN, 'DAN'],
    [emSubBetTypeZongHe.SBTH_SHUANG, 'SHUANG'],
    [emSubBetTypeZongHe.SBTH_LONG, 'LONG'],
    [emSubBetTypeZongHe.SBTH_HU, 'HU'],
    [emSubBetTypeZongHe.SBTH_HE, 'HE'],
  ]);

  // 下注子类型 - 定位球
  const mapSubDwqType = new Map<number, string>([
    [emSubBetTypeDingWei.SBTD_DA, 'DA'],
    [emSubBetTypeDingWei.SBTD_XIAO, 'XIAO'],
    [emSubBetTypeDingWei.SBTD_DAN, 'DAN'],
    [emSubBetTypeDingWei.SBTD_SHUANG, 'SHUANG'],
  ]);

  // 下注子类型 - 前/中/后三
  const mapSubQzhType = new Map<number, string>([
    [emSubBetTypeSanZhang.SBTS_ZA, 'ZANLIU'],
    [emSubBetTypeSanZhang.SBTS_BAN, 'BANSHUN'],
    [emSubBetTypeSanZhang.SBTS_SHUN, 'SHUNZI'],
    [emSubBetTypeSanZhang.SBTS_BAO, 'BAOZI'],
    [emSubBetTypeSanZhang.SBTS_DUI, 'DUIZI'],
  ]);

  // 下注子类型 - 斗牛
  const mapSubDnType = new Map<number, string>([
    [emSubBetTypeDouNiug.SBTN_DA, 'DA'],
    [emSubBetTypeDouNiug.SBTN_XIAO, 'XIAO'],
    [emSubBetTypeDouNiug.SBTN_DAN, 'DAN'],
    [emSubBetTypeDouNiug.SBTN_SHUANG, 'SHUANG'],
    [emSubBetTypeDouNiug.SBTN_GAO, 'GAOPAI'],
    [emSubBetTypeDouNiug.SBTN_DUI_1, 'YIDUI'],
    [emSubBetTypeDouNiug.SBTN_DUI_2, 'ERDUI'],
    [emSubBetTypeDouNiug.SBTN_TIAO_3, 'SANTIAO'],
    [emSubBetTypeDouNiug.SBTN_SHUN, 'SHUNZI'],
    [emSubBetTypeDouNiug.SBTN_HULU, 'HULU'],
    [emSubBetTypeDouNiug.SBTN_TIAO_4, 'SITIAO'],
    [emSubBetTypeDouNiug.SBTN_TIAO_5, 'WUTIAO'],
  ]);
  ...
  const mapResultDesc = new Map<number, string>([
    ...
    [emResultType.RT_LONG, 'LONG'],
    [emResultType.RT_HU, 'HU'],
    [emResultType.RT_HE, 'HE'],
    [emResultType.RT_ZALIU, 'ZANLIU'],
    [emResultType.RT_BANSHUN, 'BANSHUN'],
    [emResultType.RT_SHUNZI, 'SHUNZI'],
    [emResultType.RT_BAOZI, 'BAOZI'],
    [emResultType.RT_DUIZI, 'DUIZI'],
    [emResultType.RT_NIU_0, 'WUNIU'],
    [emResultType.RT_NIU_1, 'NIUYI'],
    [emResultType.RT_NIU_2, 'NIUER'],
    [emResultType.RT_NIU_3, 'NIUSAN'],
    [emResultType.RT_NIU_4, 'NIUSI'],
    [emResultType.RT_NIU_5, 'NIUWU'],
    [emResultType.RT_NIU_6, 'NIULIU'],
    [emResultType.RT_NIU_7, 'NIUQI'],
    [emResultType.RT_NIU_8, 'NIUBA'],
    [emResultType.RT_NIU_9, 'NIUJIU'],
    [emResultType.RT_NIU_10, 'NIUNIU'],
    [emResultType.RT_NIU_DA, 'DA'],
    [emResultType.RT_NIU_XIAO, 'XIAO'],
    [emResultType.RT_NIU_DAN, 'DAN'],
    [emResultType.RT_NIU_SHUANG, 'SHUANG'],
    [emResultType.RT_NIU_GAO, 'GAOPAI'],
    [emResultType.RT_NIU_DUI_1, 'YIDUI'],
    [emResultType.RT_NIU_DUI_2, 'ERDUI'],
    [emResultType.RT_NIU_TIAO_3, 'SANTIAO'],
    [emResultType.RT_NIU_SHUN, 'SHUNZI'],
    [emResultType.RT_NIU_HULU, 'HULU'],
    [emResultType.RT_NIU_TIAO_4, 'SITIAO'],
    [emResultType.RT_NIU_TIAO_5, 'WUTIAO'],
  ]);
  ...
  export function GetGamePeriodNumberResult(
    ...
    listStr.push(
      GetGameDnResultDesc(resultType[emResultPosType.RPT_HE_DX].value)
    );
    listStr.push(
      GetGameDnResultDesc(resultType[emResultPosType.RPT_HE_DS].value)
    );
    listStr.push(
      GetGameDnResultDesc(resultType[emResultPosType.RPT_HE_LHH].value)
    );
    listStr.push(
      GetGameDnResultDesc(resultType[emResultPosType.RPT_NIU_DIAN].value)
    );
    listStr.push(
      GetGameDnResultDesc(resultType[emResultPosType.RPT_NIU_SH].value)
    );
    listStr.push(
      'QIAN&' +
        GetGameDnResultDesc(resultType[emResultPosType.RPT_SAN_QIAN].value)
    );
    listStr.push(
      'ZHONG&' +
        GetGameDnResultDesc(resultType[emResultPosType.RPT_SAN_ZHONG].value)
    );
    listStr.push(
      'hou&' +
        GetGameDnResultDesc(resultType[emResultPosType.RPT_SAN_HOU].value)
    );
    return listStr;
  }
}
